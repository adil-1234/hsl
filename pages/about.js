      ...
      <div className="max-w-6xl mx-auto px-6 py-12 text-left">
        ...
        <section>
          ...
          <p className="mt-3 text-slate-600 leading-relaxed max-w-3xl">
            ...
            contexts, and domains (from tiny IoT devices to large-scale cloud systems; from
            individual user contexts to global applications; across education, code generation,
        ...
        <section className="mt-8">
          ...
          <p className="mt-3 text-slate-600 leading-relaxed max-w-3xl">
            ...
            knowledge-centric systems that get better with every use. Through R&amp;D and product
            deployments we generate value, and we are open to licensing our concepts to partners
            where it drives mutual growth and societal benefit.
          </p>
        </section>
        ...
        <section className="mt-8">
          ...
          <p className="mt-3 text-slate-600 leading-relaxed max-w-3xl">
            The best results at this stage come from sharing knowledge and working together. We
            invite investors, partners, clients, and contributors to connect and collaborate with
            us in meaningful ways — with the primary intent to build better AI and a better world.
            Our patented SPROSE framework is our step towards shaping that evolution.
          </p>
        </section>
      </div>
    </Layout>
