    ...
    <Layout>
      ...
      <div className="max-w-6xl mx-auto px-6 py-12 text-left">
        ...
        <section className="mt-16">
          <h2 className="text-2xl font-semibold text-slate-800">SPROSE as a Code Generator</h2>
          ...
          {/* Problem */}
          <div className="mt-10">
            <h3 className="text-xl text-slate-800 font-medium">The Problem</h3>
          ...
          {/* Solution */}
          <div className="mt-10">
            <h3 className="text-xl text-slate-800 font-medium">The SPROSE Solution</h3>
            <p className="mt-3 text-slate-600 leading-relaxed">
        ...
        <section className="mt-12">
          <h2 className="text-2xl font-semibold text-slate-800">The Bigger Picture</h2>
        ...
        {/* Core Innovations */}
        <section className="mt-12">
          <h2 className="text-2xl text-slate-800">Core Innovations</h2>
          <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="p-5 border rounded-lg bg-white">
              <h3 className="text-lg text-slate-800">Deterministic Reasoning</h3>
            ...
            <div className="p-5 border rounded-lg bg-white">
              <h3 className="text-lg text-slate-800">Knowledge-first Architecture</h3>
              <p className="mt-2 text-slate-600 leading-relaxed">
            ...
            <div className="p-5 border rounded-lg bg-white">
              <h3 className="text-lg text-slate-800">Ultra Efficient Edge Execution</h3>
              <p className="mt-2 text-slate-600 leading-relaxed">
